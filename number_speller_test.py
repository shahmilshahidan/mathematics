...
class spellerTest(unittest.TestCase):
    ...
    def quadDigit(self):
        ...
        self.assertEqual(ns.spellNum(8387), 'eight thousand eighty seven')
    ...
    def quinDigit(self):
        ...
        self.assertEqual(ns.spellNum(83870), 'eighty three thousand eighty seventy')
        self.assertEqual(ns.spellNum(51629), 'fifty one thousand six hundred nine')
